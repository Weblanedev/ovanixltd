        ...
        <div className="flex flex-col gap-[15px] items-start w-full justify-center">
          ...
          <form>
            ...
            <button
              ...
              className="text-base font-medium text-white bg-red-400 rounded-md px-7 md:px-12 py-[15px] hover:bg-red-600 w-full mt-[22px] transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-red-400"
