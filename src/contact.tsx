    ...
    <div className="w-full h-full flex flex-col pt-[66px] md:pt-[80px]">
      <section className="relative h-[250px] md:h-[300px]">
        <div className="flex flex-col gap-2 items-center justify-center h-full w-full">
          <h1 className="font-medium md:font-semibold text-[50px] sm:text-[40px] md:text-[50px] md:text-left leading-snug md:leading-[62px] text-center text-primaryText">
            Contact Us
          </h1>
          <p className="text-primaryText">
            Find the best way to get help and connect with Ovanix
          </p>
        </div>
      </section>
      ...
      <section className="relative p-10 md:px-[130px] md:pt-[50px] md:mb-[100px] flex flex-col md:flex-row gap-10 items-start w-full justify-between">
        <div className="w-full flex gap-8 flex-col items-center justify-center lg:border-r pr-10">
          <div className="flex flex-col gap-2.5 text-primaryText items-center justify-center md:w-[720px]">
            <h4 className="text-base font-medium text-primaryText">
              GET IN TOUCH
            </h4>
            <h2 className="text-[35px] font-medium text-primaryText">
              Schedule Meeting
            </h2>
          ...
          <div className="w-full md:w-[720px]">
            ...
            >
              <div className="flex flex-col w-full gap-5 md:flex-row">
                <input
                  type="text"
                  className="border border-gray-300 text-primaryText text-[15px] block w-full rounded-md p-[15px]"
              ...
              <textarea
                id="message"
                rows={7}
                className="block p-[15px] w-full text-sm text-primaryText border rounded-md border-gray-300"
              ...
              <button
                type="submit"
                className="text-base font-medium text-white bg-primary rounded-md px-7 md:px-12 py-[15px] hover:bg-primaryHover flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-primary"
        ...
        <div className="flex flex-col gap-10 items-start justify-center max-w-[300p x] md:w-full">
          <div className="flex flex-col gap-2.5 text-primaryText items-center justify-center my-[34px]">
            <h2 className="text-[35px] font-medium text-primaryText">
          ...
          <div className="flex gap-5 items-start justify-center">
            ...
            <div className="flex flex-col items-start justify-center gap-3">
              <h4 className="text-[24px] leading-[24px] font-medium text-primaryText">
                Call Us
              </h4>
